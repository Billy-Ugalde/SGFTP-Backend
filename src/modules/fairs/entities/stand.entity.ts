...
export class Stand {
    ...
    @OneToOne(() => Entrepreneur, (entrepreneur) => entrepreneur.stand, { nullable: true })
    @JoinColumn({ name: 'id_entreprenuer' })
    entreprenuer?: Entrepreneur;            //nota: es opcional porque hasta que un emprendedor se inscribe obtiene el stand
